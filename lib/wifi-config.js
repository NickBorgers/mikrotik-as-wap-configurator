...
async function configureWifiInterface(mt, wifiPath, interfaceName, ssidConfig, country, bandSettings = {}) {
  ...
  // Uses security.ft=yes for Fast Transition (works for both wifi-qcom and wifiwave2)
  // Note: wifiwave2 CAPsMAN uses ft-psk auth type in provisioning, but direct interface config uses security.ft
