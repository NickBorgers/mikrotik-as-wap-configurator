...
/**
 * Detect WiFi package type (wifi-qcom only)
 * Note: wifiwave2 support was removed in v5.0.0
 * @param {MikroTikSSH} mt - Connected SSH session
 * @returns {string|null} - 'wifi-qcom' or null if not found
 */
async function detectWifiPackage(mt) {
  ...
  if (packages.includes('wifiwave2')) {
    console.log('✗ wifiwave2 package detected - NOT SUPPORTED');
    console.log('  wifiwave2 support was removed in v5.0.0');
    console.log('  Please use v4.x for wifiwave2 devices');
    return null;
